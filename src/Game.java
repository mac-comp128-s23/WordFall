...
public class Game {
    ...
    private int stepInterval; // in milliseconds
    ...
    public void moveDown(long lastStepTime) {
        // Wait until the step interval has passed and make sure the game is still running.
        if(System.currentTimeMillis() - lastStepTime < stepInterval || !gameIsRunning) {
            return;
        }

        lastStepTime = System.currentTimeMillis();
        System.out.println(lastStepTime);
    ...
    public Game() {
        ...
        canvas.animate(() -> moveDown(lastStepTime));
